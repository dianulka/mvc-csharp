...
namespace MvcGooodBoooks.Migrations
{
    ...
    [Migration("20240527165439_AddEmailToReader")]
    partial class AddEmailToReader
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MvcGooodBoooks.Models.Review", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BookId = 1,
                            CreatedDate = new DateTime(2024, 5, 27, 18, 54, 36, 151, DateTimeKind.Local).AddTicks(904),
                            ReaderId = 1,
